<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 " id="sidenav-main">
    ...
    <div class="collapse navbar-collapse  w-auto h-auto h-100" id="sidenav-collapse-main">
      <ul class="navbar-nav">
        ...
        <li class="nav-item">
          <a data-bs-toggle="collapse" href="#pagesExample1" class="nav-link " aria-controls="pagesExample1" role="button" aria-expanded="false">
            <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center d-flex align-items-center justify-content-center  me-2">
              <svg width="12px" height="12px" viewBox="0 0 42 42" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                <title>office</title>
                <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
          ...
          <div class="collapse " id="pagesExample1">
            <ul class="nav ms-4 ps-3">
                <li class="nav-item">
        ...
        <li class="nav-item">
          <a data-bs-toggle="collapse" href="#pagesExample3" class="nav-link " aria-controls="pagesExample" role="button" aria-expanded="false">
            <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center d-flex align-items-center justify-content-center  me-2">
              <svg width="12px" height="12px" viewBox="0 0 42 42" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                <title>office</title>
                <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
          ...
          <div class="collapse " id="pagesExample3">
            <ul class="nav ms-4 ps-3">
                <li class="nav-item">
        ...
        <li class="nav-item mt-3">
          <h6 class="ps-4  ms-2 text-uppercase text-xs font-weight-bolder opacity-6">posts</h6>
        </li>
        <li class="nav-item">
          <a data-bs-toggle="collapse" href="#pagesExample2" class="nav-link " aria-controls="pagesExample" role="button" aria-expanded="false">
            <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center d-flex align-items-center justify-content-center  me-2">
              <svg width="12px" height="12px" viewBox="0 0 42 42" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                <title>office</title>
                <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
          ...
          <div class="collapse " id="pagesExample2">
            <ul class="nav ms-4 ps-3">
                <li class="nav-item">
                  <a class="nav-link " href="{{route('posts.index')}}">
                    <span class="sidenav-mini-icon text-xs"> P </span>
                    <span class="sidenav-normal"> all posts </span>
                  </a>
                </li>
            </ul>
          </div>
        ...
        <li class="nav-item">
          <a data-bs-toggle="collapse" href="#pagesExample4" class="nav-link " aria-controls="pagesExample" role="button" aria-expanded="false">
            <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center d-flex align-items-center justify-content-center  me-2">
              <svg width="12px" height="12px" viewBox="0 0 42 42" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                <title>office</title>
                <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
          ...
          <div class="collapse " id="pagesExample4">
            <ul class="nav ms-4 ps-3">
                <li class="nav-item">
                  <a class="nav-link " href="{{route('payment')}}">
                    <span class="sidenav-mini-icon text-xs"> P </span>
                    <span class="sidenav-normal"> payment fatoorah </span>
                  </a>
                </li>
                <li class="nav-item">
                  <a class="nav-link " href="{{route('invoices.index')}}">
                    <span class="sidenav-mini-icon text-xs"> P </span>
                    <span class="sidenav-normal"> all invoices </span>
                  </a>
                </li>
            </ul>
          </div>
        ...
        <li class="nav-item mt-3">
          <h6 class="ps-4  ms-2 text-uppercase text-xs font-weight-bolder opacity-6">chat</h6>
        </li>
        <li class="nav-item">
          <a data-bs-toggle="collapse" href="#pagesExample5" class="nav-link " aria-controls="pagesExample" role="button" aria-expanded="false">
            <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center d-flex align-items-center justify-content-center  me-2">
              <svg width="12px" height="12px" viewBox="0 0 42 42" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                <title>office</title>
                <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
          ...
          <div class="collapse " id="pagesExample5">
            <ul class="nav ms-4 ps-3">
                <li class="nav-item">
